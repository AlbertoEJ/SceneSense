...
- **Photo mode** - Capture a photo and get an instant AI description
...
app/src/main/java/com/example/visionai/
  MainViewModel.kt          # State management, inference orchestration, Q&A logic
  inference/
    LlamaModel.kt           # JNI bridge to llama.cpp (image + video inference)
  ui/
...
app/src/main/cpp/
  visionai_jni.cpp          # JNI implementation calling llama.cpp
